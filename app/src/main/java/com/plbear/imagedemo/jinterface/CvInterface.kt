...
class CvInterface {
    ...
    external fun maxFilter(pixels: IntArray, w: Int, h: Int): IntArray
    external fun minFilter(pixels: IntArray, width: Int, height: Int): IntArray
    external fun d2Filter(pixels: IntArray, width: Int, height: Int): IntArray
}